...
public class TeamsFranchisesAdapter extends BaseAdapter {
    private final Context context;
    private int layoutResourceId;
    private List<TeamsFranchisesViewModel.Franchise> values;

    public TeamsFranchisesAdapter(Context context, int layoutResourceId, List<TeamsFranchisesViewModel.Franchise> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TeamsFranchisesViewModel.Franchise resultRow = values.get(position);
